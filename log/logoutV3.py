...
#    print(data_split)
    ...
    for i in range(len(data_Remark_Json)):
        data_list.append(eval(data_Remark_Json[i].replace(r'\n','').replace('\\','')))
...
#   根据文件大小处理
    paths=[r'D:/company/日志/logtest'] #/data/MochaApi/log
#    fileread(r'D:/company/日志/logtest/cocohub.20180322.005053.448.log','Total')
