# -*- coding: utf-8 -*-
"""
Created on Fri Feb  9 11:10:04 2018
...
flags = tf.app.flags
FLAGS = flags.FLAGS
#flags.DEFINE_string('data_dir2', r'D:\python\Tensorflow', 'Directory for storing data') # 第一次启动会下载文本资料，放在/tmp/data文件夹下

print(FLAGS.data_dir1)
mnist = input_data.read_data_sets(FLAGS.data_dir1, one_hot=True)
